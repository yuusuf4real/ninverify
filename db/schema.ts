...
export const ninVerifications = pgTable(
  "nin_verifications",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
...
export const ticketMessages = pgTable(
  ...
  (table) => ({
    ticketIdx: index("idx_ticket_messages_ticket").on(
      table.ticketId,
      table.createdAt,
    ),
    senderIdx: index("idx_ticket_messages_sender").on(table.senderId),
    typeIdx: index("idx_ticket_messages_type").on(
      table.senderType,
      table.messageType,
    ),
  }),
...
export const adminActions = pgTable(
  ...
  (table) => ({
    adminIdx: index("idx_admin_actions_admin").on(
      table.adminId,
      table.createdAt,
    ),
