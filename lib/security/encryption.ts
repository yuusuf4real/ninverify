...
export class DataEncryption {
  ...
  private static getEncryptionKey(): Buffer {
    const key =
      process.env.ENCRYPTION_KEY || "default-key-for-testing-only-not-secure";
...
export class PIIProtection {
  ...
  private static readonly SENSITIVE_FIELDS =
    SECURITY_CONFIG.ENCRYPTION.SENSITIVE_FIELDS;

  /**
   * Encrypt PII fields in an object
   */
  static encryptPII<T extends Record<string, unknown>>(data: T): T {
   ...
   */
  static decryptPII<T extends Record<string, unknown>>(data: T): T {
   ...
   */
  static maskPII<T extends Record<string, unknown>>(data: T): T {
   ...
   */
  static sanitizeForLogging<T extends Record<string, unknown>>(
    data: T,
  ): Partial<T> {
   ...
   */
  static generateRetentionReport(data: Record<string, unknown>[]): {
    totalRecords: number;
    piiRecords: number;
