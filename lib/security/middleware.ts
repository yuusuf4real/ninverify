...
export class SecurityMiddleware {
   ...
   */
  static validateRequest(request: NextRequest): { valid: boolean; errors: string[] } {
   ...
   * Bot detection
   */
  static detectBot(request: NextRequest): { isBot: boolean; confidence: number } {
   ...
   */
  static analyzeRequestTiming(request: NextRequest): { suspicious: boolean; reason?: string } {
  ...
  return async function securityMiddleware(
    ...
    if (!securityCheck.allowed) {
      ...
      if (securityCheck.rateLimitInfo) {
        response.headers.set('X-RateLimit-Remaining', securityCheck.rateLimitInfo.remaining.toString());
        response.headers.set('X-RateLimit-Reset', securityCheck.rateLimitInfo.resetTime.toString());
      }
