...
const features = [
  {
    ...
    description:
      "Add ₦500 or more via card or bank transfer with instant confirmation.",
    icon: Wallet,
  ...
  },
  {
    ...
    description:
      "Smart input keeps the NIN readable and validates before submission.",
    icon: Fingerprint,
  ...
  },
  {
    ...
    description:
      "Real-time NIMC data response for name, DOB, and phone number.",
    icon: FileCheck2,
  ...
  },
  {
    ...
    description:
      "Download an official verification document with verified identity data for any purpose.",
    icon: CreditCard,
